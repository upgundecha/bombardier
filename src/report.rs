        ...
        html {
            ...
            body {
                ...
                div(class="jumbotron text-center") {
                    h1 : "Bombardier";
                    a(class="github-button",href="https://github.com/coding-yogi/bombardier",
                            data-size="large", data-show-count="true", aria-label="Star coding-yogi/bombardier on GitHub"): "Star Bombardier on GitHub ";
                    h3: "Test Report";
                }
